...
<body>
    ...
    <div class="grid-container">
        ...
        <main>
            <h2>Cuidados: Manutenção</h2>
            <section class="main-container">
                <a href="guia.php?id=rega" class="ancora"></a>
                <div class="thumbnail"><img src="../assets/img/placeholder.jpeg"></div>
                <div class="descricao">
                    <h2>Guia Definitivo da Rega</h2>
                    <p>Não afogue suas plantas! Saiba quando e quanto regar.</p>
                    <a href="guia.php?id=rega">Ler mais...</a>
                </div>
            </section>
            <section class="main-container">
                <a href="guia.php?id=poda" class="ancora"></a>
                <div class="thumbnail"><img src="../assets/img/placeholder.jpeg"></div>
                <div class="descricao">
                    <h2>Como fazer a Poda</h2>
                    <p>Estimule o crescimento removendo as partes certas.</p>
                    <a href="guia.php?id=poda">Ler mais...</a>
                </div>
            </section>
        </main>
