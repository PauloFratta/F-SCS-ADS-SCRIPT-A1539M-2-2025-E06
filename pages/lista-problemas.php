...
<body>
    ...
    <div class="grid-container">
        ...
        <main>
            <h2 style="padding: 20px; color: var(--musgo);">Cuidados: Problemas Comuns</h2>
            
            <section class="main-container">
                <a href="guia.php?id=pulgoes" class="ancora"></a>
                <div class="thumbnail"><img src="../assets/img/placeholder.jpeg" alt="Pulgões"></div>
                <div class="descricao">
                    <h2>Pragas: Pulgões e Cochonilhas</h2>
                    <h3>Autor: Daniel</h3>
                    <p>Receitas caseiras para eliminar essas pragas do seu jardim.</p>
                    <a href="guia.php?id=pulgoes">Ler guia completo...</a>
                </div>
            </section>

            <section class="main-container">
                <a href="guia.php?id=folhas-amarelas" class="ancora"></a>
                <div class="thumbnail"><img src="../assets/img/placeholder.jpeg" alt="Folhas Amarelas"></div>
                <div class="descricao">
                    <h2>Folhas Amarelas: O que é?</h2>
                    <h3>Autor: Fabio</h3>
                    <p>Entenda os sinais que sua planta dá quando algo está errado.</p>
                    <a href="guia.php?id=folhas-amarelas">Ler guia completo...</a>
                </div>
            </section>
        </main>
