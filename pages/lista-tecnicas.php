...
<body>
    ...
    <div class="grid-container">
        ...
        <main>
            <h2 style="padding: 20px; color: var(--musgo);">Cuidados: Técnicas</h2>
            
            <section class="main-container">
                <a href="guia.php?id=compostagem" class="ancora"></a>
                <div class="thumbnail"><img src="../assets/img/placeholder.jpeg" alt="Compostagem"></div>
                <div class="descricao">
                    <h2>Compostagem Doméstica</h2>
                    <h3>Autor: Daniel</h3>
                    <p>Transforme seu lixo orgânico em adubo rico para as plantas.</p>
                    <a href="guia.php?id=compostagem">Ler guia completo...</a>
                </div>
            </section>

            <section class="main-container">
                <a href="guia.php?id=adubacao" class="ancora"></a>
                <div class="thumbnail"><img src="../assets/img/placeholder.jpeg" alt="Adubação"></div>
                <div class="descricao">
                    <h2>Adubação Orgânica</h2>
                    <h3>Autor: Fabio</h3>
                    <p>Como nutrir o solo sem usar produtos químicos pesados.</p>
                    <a href="guia.php?id=adubacao">Ler guia completo...</a>
                </div>
            </section>
        </main>
